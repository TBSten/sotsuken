import { AutoAwesome, CheckCircleOutline, HourglassTop, NotInterested, SvgIconComponent } from "@mui/icons-material"
...
export const status = ["pending", "granted", "rejected", "auto"] as const
export const statusMap: Record<(typeof status)[number], Status> = {
    ...
    "rejected": { text: "却下", icon: NotInterested, color: "error" },
}
